...
export const I18N: Record<string, Record<Lang, string>> = {
  ...
  'home.demoMode':        { zh: 'Web 端演示模式', en: 'Web demo mode' },
  ...
  'topbar.lang.toggle':   { zh: '切换到英文', en: 'Switch to Chinese' },
  'topbar.theme.light':   { zh: '浅色', en: 'Light' },
  'topbar.theme.dark':    { zh: '深色', en: 'Dark' },

  'world.subtitle':       { zh: 'WORLD · 虚拟空间', en: 'WORLD · virtual space' },
  'world.title':          { zh: '世界视图', en: 'World View' },
  'world.body':           { zh: '这里将展示你的 OC 所在的虚拟世界——任务、成就、探索区域。正在建设中，敬请期待。', en: 'This space will show the virtual world your OC lives in: quests, achievements, and explorable areas. It is still under construction.' },
