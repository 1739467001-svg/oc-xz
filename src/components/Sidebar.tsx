...
const DEMO_SESSIONS: Record<'zh' | 'en', DemoSession[]> = {
  en: [
    { id: 's1', title: 'It got colder today. Bring an extra layer.', date: '14:32', preview: '"You went to bed at 1am last night."', tag: 'today' },
    { id: 's2', title: 'About that dream last night', date: 'yesterday', preview: 'You dreamed of a talking orange.', tag: 'today' },
    { id: 's3', title: 'I procrastinated again...', date: '2 days ago', preview: 'I helped you cut the task smaller.', tag: 'today' },
    { id: 's4', title: 'Day 27 · the cafe you mentioned', date: '5 days ago', preview: 'Hyacinth latte, rainy day.', tag: 'earlier' },
    { id: 's5', title: 'A letter to XZ', date: '2 weeks ago', preview: 'It does not have to be sent.', tag: 'earlier' },
    { id: 's6', title: 'Weekend plan discussion', date: '3 weeks ago', preview: 'You wanted to see that exhibition.', tag: 'earlier' },
  ],
  zh: [
...
export default function Sidebar({ active, setActive, collapsed, setCollapsed, onNewSession, onOpenPalette, avatarDataUrl }: SidebarProps) {
  ...
  const defaultSessions = DEMO_SESSIONS[lang];
...
function SessionRow({ session, active, onClick }: { session: DemoSession; active: boolean; onClick: () => void }) {
  return (
